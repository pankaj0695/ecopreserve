      ...
      <div className={styles.container}>
        <section className={styles.section}>
          <div className={styles.textContent}>
            ...
            <p>
              At our Conflict Resolution Hub, we believe that every conflict
              holds an opportunity for growth and understanding. Our mission is
              to provide you with the tools and resources you need to navigate
              and resolve conflicts effectively. Whether you're dealing with
        ...
        <section className={styles.section}>
          ...
          <div className={styles.textContent}>
            <h2>
              Welcome to Our Community Service and Social Responsibility
              Platform
            </h2>
            <p>
              ...
              community members who share a passion for making a positive
              impact. Together, we can create meaningful change and build a
